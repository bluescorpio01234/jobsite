...
<body>
    ...
    <script>
        ...
        function updateJobCount() {
            fetch('get-job-count.php') // Replace 'get-job-count.php' with the actual backend API endpoint that retrieves the job count.
        ...
        window.onload = function() {
            updateJobCount(); // Update active job count
            updateAppliedJobCount(); // Update applied job count
        };


        // Call the function to update job count when the page loads
    </script>
